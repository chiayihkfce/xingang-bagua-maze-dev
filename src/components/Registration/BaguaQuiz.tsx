      ...
      {isOpen && (
        <div className="quiz-overlay" style={{
          ...
          <div className="quiz-modal-content" style={{ 
            ...
            <div className="quiz-container" style={{ position: 'relative', width: '300px', height: '300px', margin: '0 auto' }}>
              {/* 靜止的金邊外框 */}
              <div style={{
                position: 'absolute', top: 0, left: 0, width: '100%', height: '100%',
                borderRadius: '50%', border: '8px solid var(--primary-gold)',
              ...
              <div ref={wheelRef} style={{ 
                width: '100%', height: '100%', position: 'relative', background: '#111', 
                borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center'
              }}>
                {BAGUAS.map((b, i) => (
                  <div key={b} style={{
                    position: 'absolute', transform: `rotate(${i * 45}deg) translateY(-110px)`, 
                    fontSize: '1.5rem', fontWeight: 'bold', color: '#c1a57b', width: '40px'
                  }}>{b}</div>
                ))}
                <div style={{
                  position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)',
                  width: '80px', height: '80px', background: '#000', borderRadius: '50%',
                  border: '2px solid var(--primary-gold)', display: 'flex', justifyContent: 'center', alignItems: 'center',
