...
const AdminSecurityAlerts: React.FC<AdminSecurityAlertsProps> = ({ currentAdmin, setShowSettings }) => {
  const needsPasswordChange = currentAdmin.username.toLowerCase().includes('admin') || 
