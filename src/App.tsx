...
function App() {
  ...
  const translations = {
    ...
    en: {
      ...
      openingBagua: 'Unlocking the Bagua Time-Space',
      traversingTime: 'Navigating the threshold of history...',
      ...
      expectedTime: 'Preferred Date & Time:',
      pickupLoc: 'Pickup Point:',
      total: 'Grand Total:',
      ...
      phoneFull: 'Tel: +886-5-3745074 Ext. 73 (Mr. Lin)',
      ...
      errorPhone: 'Mobile number must be 10 digits',
