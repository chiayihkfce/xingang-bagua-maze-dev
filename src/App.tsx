      ...
      <div className="social-float-container">
        ...
        >
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 3.656 11.127 8.812 13.223v-9.35h-3.393v-3.873h3.393v-2.95c0-3.347 2.048-5.178 5.025-5.178 1.425 0 2.91.255 2.91.255v3.2h-1.64c-1.658 0-2.17 1.03-2.17 2.086v2.587h3.606l-.576 3.873h-3.03v9.35c5.156-2.096 8.812-7.233 8.812-13.223z"/>
          </svg>
        </a>
        <a 
